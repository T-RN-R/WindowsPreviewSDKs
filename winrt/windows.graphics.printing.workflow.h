...
namespace ABI {
    namespace Windows {
        namespace Graphics {
            namespace Printing {
                namespace Workflow {
                    MIDL_INTERFACE("2c01fea0-9ef1-5a96-b76e-fe4bb7bcaf13")
                    ...
                    public:
                        ...
                        virtual HRESULT STDMETHODCALLTYPE GetTargetStream(
...
typedef struct __x_ABI_CWindows_CGraphics_CPrinting_CWorkflow_CIPrintWorkflowPdlModificationRequestedEventArgsVtbl
{
    ...
    HRESULT (STDMETHODCALLTYPE* GetTargetStream)(__x_ABI_CWindows_CGraphics_CPrinting_CWorkflow_CIPrintWorkflowPdlModificationRequestedEventArgs* This,
        HSTRING targetContentType,
...
#define __x_ABI_CWindows_CGraphics_CPrinting_CWorkflow_CIPrintWorkflowPdlModificationRequestedEventArgs_GetTargetStream(This, targetContentType, result) \
    ((This)->lpVtbl->GetTargetStream(This, targetContentType, result))
