 ...
 *   Static Methods exist on the Windows.Devices.Printers.IIppAttributeValueStatics interface starting with version 12.0 of the Windows.Foundation.UniversalApiContract API contract
 *
 * Class implements the following interfaces:
 ...
 *   Type can be activated via the Windows.Devices.Printers.IIppIntegerRangeFactory interface starting with version 12.0 of the Windows.Foundation.UniversalApiContract API contract
 *
 * Class implements the following interfaces:
 ...
 *
 * RuntimeClass can be activated.
 *   Type can be activated via the Windows.Devices.Printers.IIppResolutionFactory interface starting with version 12.0 of the Windows.Foundation.UniversalApiContract API contract
 *
 * Class implements the following interfaces:
 ...
 *
 * RuntimeClass can be activated.
 *   Type can be activated via the Windows.Devices.Printers.IIppTextWithLanguageFactory interface starting with version 12.0 of the Windows.Foundation.UniversalApiContract API contract
 *
 * Class implements the following interfaces:
