...
#ifndef ____x_ABI_CWindows_CUI_CIWindowReferenceStatics_FWD_DEFINED__
#define ____x_ABI_CWindows_CUI_CIWindowReferenceStatics_FWD_DEFINED__
namespace ABI {
    namespace Windows {
        namespace UI {
            interface IWindowReferenceStatics;
        } /* UI */
    } /* Windows */
} /* ABI */
#define __x_ABI_CWindows_CUI_CIWindowReferenceStatics ABI::Windows::UI::IWindowReferenceStatics

#endif // ____x_ABI_CWindows_CUI_CIWindowReferenceStatics_FWD_DEFINED__
...
#ifndef DEF___FIIterator_1_Windows__CUI__CWindowReference_USE
#define DEF___FIIterator_1_Windows__CUI__CWindowReference_USE
#if !defined(RO_NO_TEMPLATE_NAME)
namespace ABI { namespace Windows { namespace Foundation { namespace Collections {
template <>
struct __declspec(uuid("79e1f15d-7e96-580c-9c99-359b151d2c46"))
IIterator<ABI::Windows::UI::WindowReference*> : IIterator_impl<ABI::Windows::Foundation::Internal::AggregateType<ABI::Windows::UI::WindowReference*, ABI::Windows::UI::IWindowReference*>>
{
    static const wchar_t* z_get_rc_name_impl()
    {
        return L"Windows.Foundation.Collections.IIterator`1<Windows.UI.WindowReference>";
    }
};
// Define a typedef for the parameterized interface specialization's mangled name.
// This allows code which uses the mangled name for the parameterized interface to access the
// correct parameterized interface specialization.
typedef IIterator<ABI::Windows::UI::WindowReference*> __FIIterator_1_Windows__CUI__CWindowReference_t;
#define __FIIterator_1_Windows__CUI__CWindowReference ABI::Windows::Foundation::Collections::__FIIterator_1_Windows__CUI__CWindowReference_t
/* Collections */ } /* Foundation */ } /* Windows */ } /* ABI */ }

#endif // !defined(RO_NO_TEMPLATE_NAME)
#endif /* DEF___FIIterator_1_Windows__CUI__CWindowReference_USE */

#endif // WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000

#if WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000

#ifndef DEF___FIIterable_1_Windows__CUI__CWindowReference_USE
#define DEF___FIIterable_1_Windows__CUI__CWindowReference_USE
#if !defined(RO_NO_TEMPLATE_NAME)
namespace ABI { namespace Windows { namespace Foundation { namespace Collections {
template <>
struct __declspec(uuid("43bdef1c-277c-5784-80f9-bde4da7e2391"))
IIterable<ABI::Windows::UI::WindowReference*> : IIterable_impl<ABI::Windows::Foundation::Internal::AggregateType<ABI::Windows::UI::WindowReference*, ABI::Windows::UI::IWindowReference*>>
{
    static const wchar_t* z_get_rc_name_impl()
    {
        return L"Windows.Foundation.Collections.IIterable`1<Windows.UI.WindowReference>";
    }
};
// Define a typedef for the parameterized interface specialization's mangled name.
// This allows code which uses the mangled name for the parameterized interface to access the
// correct parameterized interface specialization.
typedef IIterable<ABI::Windows::UI::WindowReference*> __FIIterable_1_Windows__CUI__CWindowReference_t;
#define __FIIterable_1_Windows__CUI__CWindowReference ABI::Windows::Foundation::Collections::__FIIterable_1_Windows__CUI__CWindowReference_t
/* Collections */ } /* Foundation */ } /* Windows */ } /* ABI */ }

#endif // !defined(RO_NO_TEMPLATE_NAME)
#endif /* DEF___FIIterable_1_Windows__CUI__CWindowReference_USE */

#endif // WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000

#if WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000

#ifndef DEF___FIVectorView_1_Windows__CUI__CWindowReference_USE
#define DEF___FIVectorView_1_Windows__CUI__CWindowReference_USE
#if !defined(RO_NO_TEMPLATE_NAME)
namespace ABI { namespace Windows { namespace Foundation { namespace Collections {
template <>
struct __declspec(uuid("ccfe6b68-23e9-5be8-bd6b-ca80c8d97b56"))
IVectorView<ABI::Windows::UI::WindowReference*> : IVectorView_impl<ABI::Windows::Foundation::Internal::AggregateType<ABI::Windows::UI::WindowReference*, ABI::Windows::UI::IWindowReference*>>
{
    static const wchar_t* z_get_rc_name_impl()
    {
        return L"Windows.Foundation.Collections.IVectorView`1<Windows.UI.WindowReference>";
    }
};
// Define a typedef for the parameterized interface specialization's mangled name.
// This allows code which uses the mangled name for the parameterized interface to access the
// correct parameterized interface specialization.
typedef IVectorView<ABI::Windows::UI::WindowReference*> __FIVectorView_1_Windows__CUI__CWindowReference_t;
#define __FIVectorView_1_Windows__CUI__CWindowReference ABI::Windows::Foundation::Collections::__FIVectorView_1_Windows__CUI__CWindowReference_t
/* Collections */ } /* Foundation */ } /* Windows */ } /* ABI */ }

#endif // !defined(RO_NO_TEMPLATE_NAME)
#endif /* DEF___FIVectorView_1_Windows__CUI__CWindowReference_USE */
...
namespace ABI {
    namespace Windows {
        namespace UI {
            typedef struct WindowReferenceId WindowReferenceId;
        } /* UI */
    } /* Windows */
} /* ABI */
...
/*
 *
 * Struct Windows.UI.WindowReferenceId
 *
...
/*
 *
 * Interface Windows.UI.IWindowReference
 *
 * Introduced to Windows.Foundation.UniversalApiContract in version 11.0
 *
 * Interface is a part of the implementation of type Windows.UI.WindowReference
 *
 */
#if WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000
#if !defined(____x_ABI_CWindows_CUI_CIWindowReference_INTERFACE_DEFINED__)
#define ____x_ABI_CWindows_CUI_CIWindowReference_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Windows_UI_IWindowReference[] = L"Windows.UI.IWindowReference";
namespace ABI {
    namespace Windows {
        namespace UI {
            MIDL_INTERFACE("f0acef4b-05e5-4232-b866-bb23fde8374d")
            IWindowReference : public IInspectable
            {
            public:
                virtual HRESULT STDMETHODCALLTYPE get_Id(
                    ABI::Windows::UI::WindowReferenceId* value
                    ) = 0;
            };

            extern MIDL_CONST_ID IID& IID_IWindowReference = _uuidof(IWindowReference);
        } /* UI */
    } /* Windows */
} /* ABI */

EXTERN_C const IID IID___x_ABI_CWindows_CUI_CIWindowReference;
#endif /* !defined(____x_ABI_CWindows_CUI_CIWindowReference_INTERFACE_DEFINED__) */
#endif // WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000

/*
 *
 * Interface Windows.UI.IWindowReferenceStatics
 *
 * Introduced to Windows.Foundation.UniversalApiContract in version 11.0
 *
 * Interface is a part of the implementation of type Windows.UI.WindowReference
 ...
 */
#if WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000
#if !defined(____x_ABI_CWindows_CUI_CIWindowReferenceStatics_INTERFACE_DEFINED__)
#define ____x_ABI_CWindows_CUI_CIWindowReferenceStatics_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Windows_UI_IWindowReferenceStatics[] = L"Windows.UI.IWindowReferenceStatics";
namespace ABI {
    namespace Windows {
        namespace UI {
            MIDL_INTERFACE("86a62c7b-576f-4202-a549-4909f1e07f0e")
            IWindowReferenceStatics : public IInspectable
            {
            public:
                virtual HRESULT STDMETHODCALLTYPE FindAllTopLevelWindows(
                    __FIVectorView_1_Windows__CUI__CWindowReference** result
                    ) = 0;
                virtual HRESULT STDMETHODCALLTYPE GetForWindow(
                    UINT64 hwnd,
                    ABI::Windows::UI::IWindowReference** result
                    ) = 0;
                virtual HRESULT STDMETHODCALLTYPE GetWindowReference(
                    ABI::Windows::UI::WindowReferenceId id,
                    ABI::Windows::UI::IWindowReference** result
                    ) = 0;
            };

            extern MIDL_CONST_ID IID& IID_IWindowReferenceStatics = _uuidof(IWindowReferenceStatics);
        } /* UI */
    } /* Windows */
} /* ABI */

EXTERN_C const IID IID___x_ABI_CWindows_CUI_CIWindowReferenceStatics;
#endif /* !defined(____x_ABI_CWindows_CUI_CIWindowReferenceStatics_INTERFACE_DEFINED__) */
#endif // WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000
...
/*
 *
 * Class Windows.UI.WindowReference
 *
 * Introduced to Windows.Foundation.UniversalApiContract in version 11.0
 *
 * RuntimeClass contains static methods.
 *   Static Methods exist on the Windows.UI.IWindowReferenceStatics interface starting with version 11.0 of the Windows.Foundation.UniversalApiContract API contract
 *
 * Class implements the following interfaces:
 *    Windows.UI.IWindowReference ** Default Interface **
 *
 * Class Threading Model:  Both Single and Multi Threaded Apartment
 *
 * Class Marshaling Behavior:  Agile - Class is agile
 ...
 */
#if WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000
#ifndef RUNTIMECLASS_Windows_UI_WindowReference_DEFINED
#define RUNTIMECLASS_Windows_UI_WindowReference_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Windows_UI_WindowReference[] = L"Windows.UI.WindowReference";
#endif
#endif // WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000
...
#ifndef ____x_ABI_CWindows_CUI_CIWindowReferenceStatics_FWD_DEFINED__
#define ____x_ABI_CWindows_CUI_CIWindowReferenceStatics_FWD_DEFINED__
typedef interface __x_ABI_CWindows_CUI_CIWindowReferenceStatics __x_ABI_CWindows_CUI_CIWindowReferenceStatics;
...
#if WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000
#if !defined(____FIIterator_1_Windows__CUI__CWindowReference_INTERFACE_DEFINED__)
#define ____FIIterator_1_Windows__CUI__CWindowReference_INTERFACE_DEFINED__

typedef interface __FIIterator_1_Windows__CUI__CWindowReference __FIIterator_1_Windows__CUI__CWindowReference;

//  Declare the parameterized interface IID.
EXTERN_C const IID IID___FIIterator_1_Windows__CUI__CWindowReference;

typedef struct __FIIterator_1_Windows__CUI__CWindowReferenceVtbl
{
    BEGIN_INTERFACE

    HRESULT (STDMETHODCALLTYPE* QueryInterface)(__FIIterator_1_Windows__CUI__CWindowReference* This,
        REFIID riid,
        void** ppvObject);
    ULONG (STDMETHODCALLTYPE* AddRef)(__FIIterator_1_Windows__CUI__CWindowReference* This);
    ULONG (STDMETHODCALLTYPE* Release)(__FIIterator_1_Windows__CUI__CWindowReference* This);
    HRESULT (STDMETHODCALLTYPE* GetIids)(__FIIterator_1_Windows__CUI__CWindowReference* This,
        ULONG* iidCount,
        IID** iids);
    HRESULT (STDMETHODCALLTYPE* GetRuntimeClassName)(__FIIterator_1_Windows__CUI__CWindowReference* This,
        HSTRING* className);
    HRESULT (STDMETHODCALLTYPE* GetTrustLevel)(__FIIterator_1_Windows__CUI__CWindowReference* This,
        TrustLevel* trustLevel);
    HRESULT (STDMETHODCALLTYPE* get_Current)(__FIIterator_1_Windows__CUI__CWindowReference* This,
        __x_ABI_CWindows_CUI_CIWindowReference** result);
    HRESULT (STDMETHODCALLTYPE* get_HasCurrent)(__FIIterator_1_Windows__CUI__CWindowReference* This,
        boolean* result);
    HRESULT (STDMETHODCALLTYPE* MoveNext)(__FIIterator_1_Windows__CUI__CWindowReference* This,
        boolean* result);
    HRESULT (STDMETHODCALLTYPE* GetMany)(__FIIterator_1_Windows__CUI__CWindowReference* This,
        UINT32 itemsLength,
        __x_ABI_CWindows_CUI_CIWindowReference** items,
        UINT32* result);

    END_INTERFACE
} __FIIterator_1_Windows__CUI__CWindowReferenceVtbl;

interface __FIIterator_1_Windows__CUI__CWindowReference
{
    CONST_VTBL struct __FIIterator_1_Windows__CUI__CWindowReferenceVtbl* lpVtbl;
};

#ifdef COBJMACROS

#define __FIIterator_1_Windows__CUI__CWindowReference_QueryInterface(This, riid, ppvObject) \
    ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define __FIIterator_1_Windows__CUI__CWindowReference_AddRef(This) \
    ((This)->lpVtbl->AddRef(This))

#define __FIIterator_1_Windows__CUI__CWindowReference_Release(This) \
    ((This)->lpVtbl->Release(This))

#define __FIIterator_1_Windows__CUI__CWindowReference_GetIids(This, iidCount, iids) \
    ((This)->lpVtbl->GetIids(This, iidCount, iids))

#define __FIIterator_1_Windows__CUI__CWindowReference_GetRuntimeClassName(This, className) \
    ((This)->lpVtbl->GetRuntimeClassName(This, className))

#define __FIIterator_1_Windows__CUI__CWindowReference_GetTrustLevel(This, trustLevel) \
    ((This)->lpVtbl->GetTrustLevel(This, trustLevel))

#define __FIIterator_1_Windows__CUI__CWindowReference_get_Current(This, result) \
    ((This)->lpVtbl->get_Current(This, result))

#define __FIIterator_1_Windows__CUI__CWindowReference_get_HasCurrent(This, result) \
    ((This)->lpVtbl->get_HasCurrent(This, result))

#define __FIIterator_1_Windows__CUI__CWindowReference_MoveNext(This, result) \
    ((This)->lpVtbl->MoveNext(This, result))

#define __FIIterator_1_Windows__CUI__CWindowReference_GetMany(This, itemsLength, items, result) \
    ((This)->lpVtbl->GetMany(This, itemsLength, items, result))

#endif /* COBJMACROS */

#endif // ____FIIterator_1_Windows__CUI__CWindowReference_INTERFACE_DEFINED__
#endif // WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000

#if WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000
#if !defined(____FIIterable_1_Windows__CUI__CWindowReference_INTERFACE_DEFINED__)
#define ____FIIterable_1_Windows__CUI__CWindowReference_INTERFACE_DEFINED__

typedef interface __FIIterable_1_Windows__CUI__CWindowReference __FIIterable_1_Windows__CUI__CWindowReference;

//  Declare the parameterized interface IID.
EXTERN_C const IID IID___FIIterable_1_Windows__CUI__CWindowReference;

typedef struct __FIIterable_1_Windows__CUI__CWindowReferenceVtbl
{
    BEGIN_INTERFACE

    HRESULT (STDMETHODCALLTYPE* QueryInterface)(__FIIterable_1_Windows__CUI__CWindowReference* This,
        REFIID riid,
        void** ppvObject);
    ULONG (STDMETHODCALLTYPE* AddRef)(__FIIterable_1_Windows__CUI__CWindowReference* This);
    ULONG (STDMETHODCALLTYPE* Release)(__FIIterable_1_Windows__CUI__CWindowReference* This);
    HRESULT (STDMETHODCALLTYPE* GetIids)(__FIIterable_1_Windows__CUI__CWindowReference* This,
        ULONG* iidCount,
        IID** iids);
    HRESULT (STDMETHODCALLTYPE* GetRuntimeClassName)(__FIIterable_1_Windows__CUI__CWindowReference* This,
        HSTRING* className);
    HRESULT (STDMETHODCALLTYPE* GetTrustLevel)(__FIIterable_1_Windows__CUI__CWindowReference* This,
        TrustLevel* trustLevel);
    HRESULT (STDMETHODCALLTYPE* First)(__FIIterable_1_Windows__CUI__CWindowReference* This,
        __FIIterator_1_Windows__CUI__CWindowReference** result);

    END_INTERFACE
} __FIIterable_1_Windows__CUI__CWindowReferenceVtbl;

interface __FIIterable_1_Windows__CUI__CWindowReference
{
    CONST_VTBL struct __FIIterable_1_Windows__CUI__CWindowReferenceVtbl* lpVtbl;
};

#ifdef COBJMACROS

#define __FIIterable_1_Windows__CUI__CWindowReference_QueryInterface(This, riid, ppvObject) \
    ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define __FIIterable_1_Windows__CUI__CWindowReference_AddRef(This) \
    ((This)->lpVtbl->AddRef(This))

#define __FIIterable_1_Windows__CUI__CWindowReference_Release(This) \
    ((This)->lpVtbl->Release(This))

#define __FIIterable_1_Windows__CUI__CWindowReference_GetIids(This, iidCount, iids) \
    ((This)->lpVtbl->GetIids(This, iidCount, iids))

#define __FIIterable_1_Windows__CUI__CWindowReference_GetRuntimeClassName(This, className) \
    ((This)->lpVtbl->GetRuntimeClassName(This, className))

#define __FIIterable_1_Windows__CUI__CWindowReference_GetTrustLevel(This, trustLevel) \
    ((This)->lpVtbl->GetTrustLevel(This, trustLevel))

#define __FIIterable_1_Windows__CUI__CWindowReference_First(This, result) \
    ((This)->lpVtbl->First(This, result))

#endif /* COBJMACROS */

#endif // ____FIIterable_1_Windows__CUI__CWindowReference_INTERFACE_DEFINED__
#endif // WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000

#if WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000
#if !defined(____FIVectorView_1_Windows__CUI__CWindowReference_INTERFACE_DEFINED__)
#define ____FIVectorView_1_Windows__CUI__CWindowReference_INTERFACE_DEFINED__

typedef interface __FIVectorView_1_Windows__CUI__CWindowReference __FIVectorView_1_Windows__CUI__CWindowReference;

//  Declare the parameterized interface IID.
EXTERN_C const IID IID___FIVectorView_1_Windows__CUI__CWindowReference;

typedef struct __FIVectorView_1_Windows__CUI__CWindowReferenceVtbl
{
    BEGIN_INTERFACE

    HRESULT (STDMETHODCALLTYPE* QueryInterface)(__FIVectorView_1_Windows__CUI__CWindowReference* This,
        REFIID riid,
        void** ppvObject);
    ULONG (STDMETHODCALLTYPE* AddRef)(__FIVectorView_1_Windows__CUI__CWindowReference* This);
    ULONG (STDMETHODCALLTYPE* Release)(__FIVectorView_1_Windows__CUI__CWindowReference* This);
    HRESULT (STDMETHODCALLTYPE* GetIids)(__FIVectorView_1_Windows__CUI__CWindowReference* This,
        ULONG* iidCount,
        IID** iids);
    HRESULT (STDMETHODCALLTYPE* GetRuntimeClassName)(__FIVectorView_1_Windows__CUI__CWindowReference* This,
        HSTRING* className);
    HRESULT (STDMETHODCALLTYPE* GetTrustLevel)(__FIVectorView_1_Windows__CUI__CWindowReference* This,
        TrustLevel* trustLevel);
    HRESULT (STDMETHODCALLTYPE* GetAt)(__FIVectorView_1_Windows__CUI__CWindowReference* This,
        UINT32 index,
        __x_ABI_CWindows_CUI_CIWindowReference** result);
    HRESULT (STDMETHODCALLTYPE* get_Size)(__FIVectorView_1_Windows__CUI__CWindowReference* This,
        UINT32* result);
    HRESULT (STDMETHODCALLTYPE* IndexOf)(__FIVectorView_1_Windows__CUI__CWindowReference* This,
        __x_ABI_CWindows_CUI_CIWindowReference* value,
        UINT32* index,
        boolean* result);
    HRESULT (STDMETHODCALLTYPE* GetMany)(__FIVectorView_1_Windows__CUI__CWindowReference* This,
        UINT32 startIndex,
        UINT32 itemsLength,
        __x_ABI_CWindows_CUI_CIWindowReference** items,
        UINT32* result);
    ...
    END_INTERFACE
} __FIVectorView_1_Windows__CUI__CWindowReferenceVtbl;

interface __FIVectorView_1_Windows__CUI__CWindowReference
{
    CONST_VTBL struct __FIVectorView_1_Windows__CUI__CWindowReferenceVtbl* lpVtbl;
};

#ifdef COBJMACROS

#define __FIVectorView_1_Windows__CUI__CWindowReference_QueryInterface(This, riid, ppvObject) \
    ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define __FIVectorView_1_Windows__CUI__CWindowReference_AddRef(This) \
    ((This)->lpVtbl->AddRef(This))

#define __FIVectorView_1_Windows__CUI__CWindowReference_Release(This) \
    ((This)->lpVtbl->Release(This))

#define __FIVectorView_1_Windows__CUI__CWindowReference_GetIids(This, iidCount, iids) \
    ((This)->lpVtbl->GetIids(This, iidCount, iids))

#define __FIVectorView_1_Windows__CUI__CWindowReference_GetRuntimeClassName(This, className) \
    ((This)->lpVtbl->GetRuntimeClassName(This, className))

#define __FIVectorView_1_Windows__CUI__CWindowReference_GetTrustLevel(This, trustLevel) \
    ((This)->lpVtbl->GetTrustLevel(This, trustLevel))

#define __FIVectorView_1_Windows__CUI__CWindowReference_GetAt(This, index, result) \
    ((This)->lpVtbl->GetAt(This, index, result))

#define __FIVectorView_1_Windows__CUI__CWindowReference_get_Size(This, result) \
    ((This)->lpVtbl->get_Size(This, result))

#define __FIVectorView_1_Windows__CUI__CWindowReference_IndexOf(This, value, index, result) \
    ((This)->lpVtbl->IndexOf(This, value, index, result))

#define __FIVectorView_1_Windows__CUI__CWindowReference_GetMany(This, startIndex, itemsLength, items, result) \
    ((This)->lpVtbl->GetMany(This, startIndex, itemsLength, items, result))

#endif /* COBJMACROS */

#endif // ____FIVectorView_1_Windows__CUI__CWindowReference_INTERFACE_DEFINED__
#endif // WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000

typedef struct __x_ABI_CWindows_CUI_CColor __x_ABI_CWindows_CUI_CColor;

typedef struct __x_ABI_CWindows_CUI_CWindowReferenceId __x_ABI_CWindows_CUI_CWindowReferenceId;
 ...
 */
#if WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000
struct __x_ABI_CWindows_CUI_CWindowReferenceId
{
    UINT64 Value;
};
#endif // WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0xb0000
...
#define ____x_ABI_CWindows_CUI_CIWindowReference_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Windows_UI_IWindowReference[] = L"Windows.UI.IWindowReference";
typedef struct __x_ABI_CWindows_CUI_CIWindowReferenceVtbl
{
    BEGIN_INTERFACE

    HRESULT (STDMETHODCALLTYPE* QueryInterface)(__x_ABI_CWindows_CUI_CIWindowReference* This,
        REFIID riid,
        void** ppvObject);
    ULONG (STDMETHODCALLTYPE* AddRef)(__x_ABI_CWindows_CUI_CIWindowReference* This);
    ULONG (STDMETHODCALLTYPE* Release)(__x_ABI_CWindows_CUI_CIWindowReference* This);
    HRESULT (STDMETHODCALLTYPE* GetIids)(__x_ABI_CWindows_CUI_CIWindowReference* This,
        ULONG* iidCount,
        IID** iids);
    HRESULT (STDMETHODCALLTYPE* GetRuntimeClassName)(__x_ABI_CWindows_CUI_CIWindowReference* This,
        HSTRING* className);
    HRESULT (STDMETHODCALLTYPE* GetTrustLevel)(__x_ABI_CWindows_CUI_CIWindowReference* This,
        TrustLevel* trustLevel);
    HRESULT (STDMETHODCALLTYPE* get_Id)(__x_ABI_CWindows_CUI_CIWindowReference* This,
        struct __x_ABI_CWindows_CUI_CWindowReferenceId* value);

    END_INTERFACE
} __x_ABI_CWindows_CUI_CIWindowReferenceVtbl;

interface __x_ABI_CWindows_CUI_CIWindowReference
{
    CONST_VTBL struct __x_ABI_CWindows_CUI_CIWindowReferenceVtbl* lpVtbl;
};

#ifdef COBJMACROS

#define __x_ABI_CWindows_CUI_CIWindowReference_QueryInterface(This, riid, ppvObject) \
    ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define __x_ABI_CWindows_CUI_CIWindowReference_AddRef(This) \
    ((This)->lpVtbl->AddRef(This))

#define __x_ABI_CWindows_CUI_CIWindowReference_Release(This) \
    ((This)->lpVtbl->Release(This))

#define __x_ABI_CWindows_CUI_CIWindowReference_GetIids(This, iidCount, iids) \
    ((This)->lpVtbl->GetIids(This, iidCount, iids))

#define __x_ABI_CWindows_CUI_CIWindowReference_GetRuntimeClassName(This, className) \
    ((This)->lpVtbl->GetRuntimeClassName(This, className))

#define __x_ABI_CWindows_CUI_CIWindowReference_GetTrustLevel(This, trustLevel) \
    ((This)->lpVtbl->GetTrustLevel(This, trustLevel))

#define __x_ABI_CWindows_CUI_CIWindowReference_get_Id(This, value) \
...
#define ____x_ABI_CWindows_CUI_CIWindowReferenceStatics_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Windows_UI_IWindowReferenceStatics[] = L"Windows.UI.IWindowReferenceStatics";
typedef struct __x_ABI_CWindows_CUI_CIWindowReferenceStaticsVtbl
{
    BEGIN_INTERFACE

    HRESULT (STDMETHODCALLTYPE* QueryInterface)(__x_ABI_CWindows_CUI_CIWindowReferenceStatics* This,
        REFIID riid,
        void** ppvObject);
    ULONG (STDMETHODCALLTYPE* AddRef)(__x_ABI_CWindows_CUI_CIWindowReferenceStatics* This);
    ULONG (STDMETHODCALLTYPE* Release)(__x_ABI_CWindows_CUI_CIWindowReferenceStatics* This);
    HRESULT (STDMETHODCALLTYPE* GetIids)(__x_ABI_CWindows_CUI_CIWindowReferenceStatics* This,
        ULONG* iidCount,
        IID** iids);
    HRESULT (STDMETHODCALLTYPE* GetRuntimeClassName)(__x_ABI_CWindows_CUI_CIWindowReferenceStatics* This,
        HSTRING* className);
    HRESULT (STDMETHODCALLTYPE* GetTrustLevel)(__x_ABI_CWindows_CUI_CIWindowReferenceStatics* This,
        TrustLevel* trustLevel);
    HRESULT (STDMETHODCALLTYPE* FindAllTopLevelWindows)(__x_ABI_CWindows_CUI_CIWindowReferenceStatics* This,
        __FIVectorView_1_Windows__CUI__CWindowReference** result);
    HRESULT (STDMETHODCALLTYPE* GetForWindow)(__x_ABI_CWindows_CUI_CIWindowReferenceStatics* This,
        UINT64 hwnd,
        __x_ABI_CWindows_CUI_CIWindowReference** result);
    HRESULT (STDMETHODCALLTYPE* GetWindowReference)(__x_ABI_CWindows_CUI_CIWindowReferenceStatics* This,
        struct __x_ABI_CWindows_CUI_CWindowReferenceId id,
        __x_ABI_CWindows_CUI_CIWindowReference** result);

    END_INTERFACE
} __x_ABI_CWindows_CUI_CIWindowReferenceStaticsVtbl;

interface __x_ABI_CWindows_CUI_CIWindowReferenceStatics
{
    CONST_VTBL struct __x_ABI_CWindows_CUI_CIWindowReferenceStaticsVtbl* lpVtbl;
};

#ifdef COBJMACROS

#define __x_ABI_CWindows_CUI_CIWindowReferenceStatics_QueryInterface(This, riid, ppvObject) \
    ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define __x_ABI_CWindows_CUI_CIWindowReferenceStatics_AddRef(This) \
    ((This)->lpVtbl->AddRef(This))

#define __x_ABI_CWindows_CUI_CIWindowReferenceStatics_Release(This) \
    ((This)->lpVtbl->Release(This))

#define __x_ABI_CWindows_CUI_CIWindowReferenceStatics_GetIids(This, iidCount, iids) \
    ((This)->lpVtbl->GetIids(This, iidCount, iids))

#define __x_ABI_CWindows_CUI_CIWindowReferenceStatics_GetRuntimeClassName(This, className) \
    ((This)->lpVtbl->GetRuntimeClassName(This, className))

#define __x_ABI_CWindows_CUI_CIWindowReferenceStatics_GetTrustLevel(This, trustLevel) \
    ((This)->lpVtbl->GetTrustLevel(This, trustLevel))

#define __x_ABI_CWindows_CUI_CIWindowReferenceStatics_FindAllTopLevelWindows(This, result) \
    ((This)->lpVtbl->FindAllTopLevelWindows(This, result))

#define __x_ABI_CWindows_CUI_CIWindowReferenceStatics_GetForWindow(This, hwnd, result) \
    ((This)->lpVtbl->GetForWindow(This, hwnd, result))

#define __x_ABI_CWindows_CUI_CIWindowReferenceStatics_GetWindowReference(This, id, result) \
    ((This)->lpVtbl->GetWindowReference(This, id, result))
