...
#define SYSTEM_IOFILTER_KW_FLT_IO          0x0000000000000001
#define SYSTEM_IOFILTER_KW_FLT_IO_INIT     0x0000000000000002
#define SYSTEM_IOFILTER_KW_FLT_FASTIO      0x0000000000000004
#define SYSTEM_IOFILTER_KW_FLT_IO_FAILURE  0x0000000000000008

//
// Keywords to be used for the System Object Provider.
//

#define SYSTEM_OBJECT_KW_OB_HANDLE 0x0000000000000001
#define SYSTEM_OBJECT_KW_OB_OBJECT 0x0000000000000002

//
// Keywords to be used for the System Power Provider.
//

#define SYSTEM_POWER_KW_POWER         0x0000000000000001
...
#define SYSTEM_HYPERVISOR_KW_HV_PROFILE  0x0000000000000001
#define SYSTEM_HYPERVISOR_KW_HV_CALLOUTS 0x0000000000000002

//
// Keywords to be used for the System SpinLock Provider.
//

#define SYSTEM_SPINLOCK_KW_SPINLOCK       0x0000000000000001
#define SYSTEM_SPINLOCK_KW_SPINLOCK_CNTRS 0x0000000000000002

//
// Keywords to be used for the System Config Provider.
//

#define SYSTEM_CONFIG_KW_SYSCFG_SYSTEM   0x0000000000000001
#define SYSTEM_CONFIG_KW_SYSCFG_GRAPHICS 0x0000000000000002
#define SYSTEM_CONFIG_KW_SYSCFG_STORAGE  0x0000000000000004
#define SYSTEM_CONFIG_KW_SYSCFG_NETWORK  0x0000000000000008
#define SYSTEM_CONFIG_KW_SYSCFG_SERVICES 0x0000000000000010
#define SYSTEM_CONFIG_KW_SYSCFG_PNP      0x0000000000000020
#define SYSTEM_CONFIG_KW_SYSCFG_OPTICAL  0x0000000000000040

//
// Keywords to be used for the System CPU Provider.
//

#define SYSTEM_CPU_KW_CPU_CONFIG       0x0000000000000001
#define SYSTEM_CPU_KW_PROCESSOR_IDLE   0x0000000000000002
#define SYSTEM_CPU_KW_IDLE_SELECTION   0x0000000000000004
#define SYSTEM_CPU_KW_PPM_EXIT_LATENCY 0x0000000000000008
#define SYSTEM_CPU_KW_IPI              0x0000000000000010
#define SYSTEM_CPU_KW_IDEAL_PROCESSOR  0x0000000000000020
#define SYSTEM_CPU_KW_TIMER            0x0000000000000040
#define SYSTEM_CPU_KW_CLOCK_INTERRUPT  0x0000000000000080
#define SYSTEM_CPU_KW_CLOCK_TIMER      0x0000000000000100
#define SYSTEM_CPU_KW_INTERRUPT        0x0000000000000200
#define SYSTEM_CPU_KW_INTERRUPT_STEER  0x0000000000000400
#define SYSTEM_CPU_KW_CACHE_FLUSH      0x0000000000000800
#define SYSTEM_CPU_KW_SYSCALL          0x0000000000001000
...
#define SYSTEM_SCHEDULER_KW_ALPC            0x0000000000000002
#define SYSTEM_SCHEDULER_KW_DPC             0x0000000000000004
#define SYSTEM_SCHEDULER_KW_DPC_QUEUE       0x0000000000000008
#define SYSTEM_SCHEDULER_KW_DISPATCHER      0x0000000000000010
#define SYSTEM_SCHEDULER_KW_SYNC_OBJECTS    0x0000000000000020
#define SYSTEM_SCHEDULER_KW_KERNEL_QUEUE    0x0000000000000040
#define SYSTEM_SCHEDULER_KW_SHOULD_YIELD    0x0000000000000080
#define SYSTEM_SCHEDULER_KW_ANTI_STARVATION 0x0000000000000100
#define SYSTEM_SCHEDULER_KW_UMS             0x0000000000000200
#define SYSTEM_SCHEDULER_KW_LOAD_BALANCER   0x0000000000000400
#define SYSTEM_SCHEDULER_KW_WDF_DPC         0x0000000000000800
#define SYSTEM_SCHEDULER_KW_WDF_INTERRUPT   0x0000000000001000
#define SYSTEM_SCHEDULER_KW_SPEC_CONTROL    0x0000000000002000

//
// Keywords to be used for the System Profile Provider.
//

#define SYSTEM_PROFILE_KW_PROFILE         0x0000000000000001
#define SYSTEM_PROFILE_KW_PMC_PROFILE     0x0000000000000002
#define SYSTEM_PROFILE_KW_CONTEXT_SWITCH  0x0000000000000004
#define SYSTEM_PROFILE_KW_COMPACT_CSWITCH 0x0000000000000008

//
// Keywords to be used for the System IO Provider.
//

#define SYSTEM_IO_KW_DISK_IO         0x0000000000000001
#define SYSTEM_IO_KW_DISK_IO_INIT    0x0000000000000002
#define SYSTEM_IO_KW_FILENAME        0x0000000000000004
#define SYSTEM_IO_KW_SPLIT_IO        0x0000000000000008
#define SYSTEM_IO_KW_FILE_IO         0x0000000000000010
#define SYSTEM_IO_KW_OPTICAL_IO      0x0000000000000020
#define SYSTEM_IO_KW_OPTICAL_IO_INIT 0x0000000000000040
#define SYSTEM_IO_KW_DRIVERS         0x0000000000000080
#define SYSTEM_IO_KW_VTL_CHANGE      0x0000000000000100
#define SYSTEM_IO_KW_CC              0x0000000000000200
#define SYSTEM_IO_KW_NETWORK         0x0000000000000400
...
#define SYSTEM_PROCESS_KW_AFFINITY       0x0000000000002000
#define SYSTEM_PROCESS_KW_PRIORITY       0x0000000000004000
...
#define SYSTEM_MEMORY_KW_MEMORY        0x0000000000000001
