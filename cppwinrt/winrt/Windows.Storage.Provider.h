...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Storage_Provider_IStorageProviderError<D>::Button1() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::Provider::IStorageProviderError)->get_Button1(&value));
        return Windows::Storage::Provider::StorageProviderErrorCommand{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Storage_Provider_IStorageProviderError<D>::Button1(Windows::Storage::Provider::StorageProviderErrorCommand const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::Provider::IStorageProviderError)->put_Button1(*(void**)(&value)));
    }
    template <typename D> auto consume_Windows_Storage_Provider_IStorageProviderError<D>::Button2() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::Provider::IStorageProviderError)->get_Button2(&value));
        return Windows::Storage::Provider::StorageProviderErrorCommand{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Storage_Provider_IStorageProviderError<D>::Button2(Windows::Storage::Provider::StorageProviderErrorCommand const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::Provider::IStorageProviderError)->put_Button2(*(void**)(&value)));
    }
    template <typename D> auto consume_Windows_Storage_Provider_IStorageProviderError<D>::Hyperlink1() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::Provider::IStorageProviderError)->get_Hyperlink1(&value));
        return Windows::Storage::Provider::StorageProviderErrorCommand{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Storage_Provider_IStorageProviderError<D>::Hyperlink1(Windows::Storage::Provider::StorageProviderErrorCommand const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::Provider::IStorageProviderError)->put_Hyperlink1(*(void**)(&value)));
    }
    ...
    template <typename D> auto consume_Windows_Storage_Provider_IStorageProviderErrorCommandFactory<D>::CreateInstance(param::hstring const& label, Windows::Foundation::Uri const& actionUri) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Storage_Provider_IStorageProviderStatusFactory<D>::CreateInstance(Windows::Storage::Provider::StorageProviderState const& state, param::hstring const& message) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Storage_Provider_IStorageProviderStatusFactory<D>::CreateInstance2(Windows::Storage::Provider::StorageProviderState const& state, param::hstring const& message, param::iterable<Windows::Storage::Provider::StorageProviderError> const& errorMessages) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Storage_Provider_IStorageProviderStatusSource<D>::Changed(Windows::Foundation::TypedEventHandler<Windows::Storage::Provider::IStorageProviderStatusSource, Windows::Foundation::IInspectable> const& handler) const
    {
        winrt::event_token token;
