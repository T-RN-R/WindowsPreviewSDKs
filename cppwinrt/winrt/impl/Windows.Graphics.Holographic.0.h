...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<Windows::Graphics::Holographic::IHolographicCameraRenderingParameters4>{ 0x0878FA4C,0xE163,0x57DC,{ 0x82,0xB7,0xC4,0x06,0xAB,0x3E,0x05,0x37 } };
    ...
    template <> inline constexpr guid guid_v<Windows::Graphics::Holographic::IHolographicViewConfiguration2>{ 0xE241756E,0xE0D0,0x5019,{ 0x9A,0xF5,0x1B,0x16,0x5B,0xC2,0xF5,0x4E } };
    ...
    struct consume_Windows_Graphics_Holographic_IHolographicCameraRenderingParameters4
    {
        ...
        auto DepthReprojectionMethod(Windows::Graphics::Holographic::HolographicDepthReprojectionMethod const& value) const;
    };
