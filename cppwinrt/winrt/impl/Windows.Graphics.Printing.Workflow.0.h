...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Graphics::Printing::Workflow::IPrintWorkflowPdlModificationRequestedEventArgs>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall GetTargetStream(void*, void**) noexcept = 0;
    ...
    struct consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowPdlModificationRequestedEventArgs
    {
        ...
        WINRT_IMPL_AUTO(Windows::Graphics::Printing::Workflow::PrintWorkflowPdlTargetStream) GetTargetStream(param::hstring const& targetContentType) const;
