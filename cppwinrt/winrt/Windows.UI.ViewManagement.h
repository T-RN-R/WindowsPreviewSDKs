...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<Windows::Foundation::Rect>) consume_Windows_UI_ViewManagement_IApplicationViewSpanningRects<D>::GetSpanningRects() const
    {
        void* result{};
