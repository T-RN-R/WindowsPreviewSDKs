...
WINRT_EXPORT namespace winrt::Windows::UI::Xaml::Media
{
    ...
    protected:
        AcrylicBrushT()
        {
            impl::call_factory<AcrylicBrush, IAcrylicBrushFactory>([&](IAcrylicBrushFactory const& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
    template <typename D, typename... Interfaces>
    struct BrushT :
    ...
    protected:
        BrushT()
        {
            impl::call_factory<Brush, IBrushFactory>([&](IBrushFactory const& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
    template <typename D, typename... Interfaces>
    struct CacheModeT :
    ...
    protected:
        CacheModeT()
        {
            impl::call_factory<CacheMode, ICacheModeFactory>([&](ICacheModeFactory const& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
    template <typename D, typename... Interfaces>
    struct FontFamilyT :
    ...
    protected:
        ...
        {
            impl::call_factory<FontFamily, IFontFamilyFactory>([&](IFontFamilyFactory const& f) { f.CreateInstanceWithName(familyName, *this, this->m_inner); });
        }
    };
    template <typename D, typename... Interfaces>
    ...
    protected:
        GeneralTransformT()
        {
            impl::call_factory<GeneralTransform, IGeneralTransformFactory>([&](IGeneralTransformFactory const& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
    template <typename D, typename... Interfaces>
    ...
    protected:
        GradientBrushT()
        {
            impl::call_factory<GradientBrush, IGradientBrushFactory>([&](IGradientBrushFactory const& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
    template <typename D, typename... Interfaces>
    struct ProjectionT :
    ...
    protected:
        ProjectionT()
        {
            impl::call_factory<Projection, IProjectionFactory>([&](IProjectionFactory const& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
    template <typename D, typename... Interfaces>
    ...
    protected:
        ...
        {
            impl::call_factory<RevealBackgroundBrush, IRevealBackgroundBrushFactory>([&](IRevealBackgroundBrushFactory const& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
    template <typename D, typename... Interfaces>
    ...
    protected:
        RevealBorderBrushT()
        {
            impl::call_factory<RevealBorderBrush, IRevealBorderBrushFactory>([&](IRevealBorderBrushFactory const& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
    template <typename D, typename... Interfaces>
    struct RevealBrushT :
    ...
    protected:
        RevealBrushT()
        {
            impl::call_factory<RevealBrush, IRevealBrushFactory>([&](IRevealBrushFactory const& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
    template <typename D, typename... Interfaces>
    struct ThemeShadowT :
    ...
    protected:
        ThemeShadowT()
        {
            impl::call_factory<ThemeShadow, IThemeShadowFactory>([&](IThemeShadowFactory const& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
    template <typename D, typename... Interfaces>
    struct TileBrushT :
    ...
    protected:
        TileBrushT()
        {
            impl::call_factory<TileBrush, ITileBrushFactory>([&](ITileBrushFactory const& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
    template <typename D, typename... Interfaces>
    ...
    protected:
        ...
        {
            impl::call_factory<XamlCompositionBrushBase, IXamlCompositionBrushBaseFactory>([&](IXamlCompositionBrushBaseFactory const& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
    template <typename D, typename... Interfaces>
    struct XamlLightT :
    ...
    protected:
        XamlLightT()
        {
            impl::call_factory<XamlLight, IXamlLightFactory>([&](IXamlLightFactory const& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
}
namespace std
